...
| Visibility | `internal` |
| Timeline scope | `GEN` |
| Schema reference | `../90_schemas_and_vocabularies/document.schema.json` |
| Created | `2026-08-13` |
| Updated | `2026-08-13` |
...
Human-readable table of contents and executive orientation.

## Principal source families to reconcile

Manifest and approved authority files.
