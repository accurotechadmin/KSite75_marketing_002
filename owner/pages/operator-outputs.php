...
$sampleRecords = [
    [
        ...
        'title' => 'Operator Outputs seed record',
...
<div class="module-layout">
    ...
    <?php owner_render_workspace(['Select source records', 'Generate operational checklist', 'Preserve source IDs in each row']); ?>
