...
$sampleRecords = [
    [
        ...
        'title' => 'Timeline Registry seed record',
...
<div class="module-layout">
    ...
    <?php owner_render_workspace(['Reserve or select Timeline Moment ID', 'Draft linked record', 'Promote only after review']); ?>
