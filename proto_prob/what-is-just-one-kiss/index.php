...
$csrf = csrf_token();
render_header('Just One KISS — What Is Just One KISS?', 'Just One KISS is a theatrical rock tribute inspired by classic rock stage mythology and built around a solo performer, show-control operator, lights, projection, fog, strobes, and costume transformation.');
render_notice($formResult);
?>
<main id="main">
  <section class="subhero section-shell" aria-labelledby="page-title">
    <p class="eyebrow">One-performer theatrical rock tribute</p>
    <h1 id="page-title">What Is Just One KISS?</h1>
    <p class="hero__lede">Just One KISS is a theatrical rock tribute inspired by classic rock stage mythology and built around a solo performer, show-control operator, lights, projection, fog, strobes, and costume transformation.</p>
