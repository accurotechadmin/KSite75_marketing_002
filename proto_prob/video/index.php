...
$csrf = csrf_token();
render_header('Just One KISS — Trailer and Clips', 'Photos and videos are allowed and encouraged; this page will carry approved original clips and fan-sharing instructions. Official recordings, album art, logos, and protected media are not used here.');
render_notice($formResult);
?>
<main id="main">
  <section class="subhero section-shell" aria-labelledby="page-title">
    <p class="eyebrow">Original media only</p>
    <h1 id="page-title">Trailer and Clips</h1>
    <p class="hero__lede">Photos and videos are allowed and encouraged; this page will carry approved original clips and fan-sharing instructions. Official recordings, album art, logos, and protected media are not used here.</p>
  ...
  <section class="section-shell image-inventory"><h2>Approved media plan</h2><p>Trailer art and original clip proof without borrowed official assets.</p><?php render_media_grid(['trailer-poster-stage-portal.webp' => 'Trailer poster stage portal']); ?></section>
</main>
<?php render_footer(); ?>
